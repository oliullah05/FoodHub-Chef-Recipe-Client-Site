...
const ChefData = ({ chefData }) => {
    ...
    return (
        <div className="card  bg-base-100 shadow-xl">
            <figure className="px-10 pt-10 rounded-lg"><img loading='lazy'  className='rounded-lg' src={chef_picture} alt="chefPicture" /></figure>
            <div className="card-body">
                <h2 className="card-title lg:text-3xl">{chef_name}</h2>
               
                <p className='font-semibold inline-flex gap-1'>
                    Likes: {likes}<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
